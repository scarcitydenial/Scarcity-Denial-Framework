...
When this Prompt 2 has successfully completed, stop and wait for explicit instruction before proceeding to Prompt 3.
```
...
When this Prompt 3 has successfully completed, stop and wait for explicit instruction before proceeding to Prompt 4.
```
...
- **DDA Version:** [DDA version number]
